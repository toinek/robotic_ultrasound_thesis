...
class KMP_transportation():
    ...
    # def find_matching_waypoints(self, source_distribution, training_traj, distance_threshold=0.05):
    #     # Find the closest points in source_distribution to each point in training_traj
    #     distances, indices = KDTree(source_distribution).query(training_traj)
    #
    ...
    def apply_transportation(self):
        ...
        if hasattr(self, 'training_delta'):
            ...
            self.training_delta = np.diff(self.training_traj, axis=0)

...
data =np.load(source_path+ '/data/'+str('example3')+'.npz')
X=data['demo'] 
S=data['floor'] 
S1=data['newfloor']
...
plt.scatter(source_distribution[transport.mask_source,0],source_distribution[transport.mask_source,1], color=[0,0,1], marker='x', s=100)
plt.scatter(X[transport.mask_traj,0],X[transport.mask_traj,1], color=[0,1,0], marker='o', s=100)

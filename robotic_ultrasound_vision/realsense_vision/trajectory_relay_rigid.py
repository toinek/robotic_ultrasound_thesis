...
class TrajectoryRelay:
    def __init__(self, bag_path, csv_file_path):
        ...
        self.trajectory_timer = rospy.Timer(rospy.Duration(1), self.publish_trajectory_callback)
    ...
    def load_trajectory_from_csv(self):
        ...
        for i, row in df.iterrows():
            if i%10 == 0:
                pose = Pose()
                pose.position.x = row['position_x'] #+ 0.03
                pose.position.y = row['position_y'] #- 0.05
                pose.position.z = row['position_z'] - 0.12  # Adjust z-coordinate
    ...
    def publish_pcd_callback(self, event):
        """Periodic callback to publish PointCloud2 data from the rosbag."""
        try:
            with rosbag.Bag(self.bag_path, 'r') as bag:
                for topic, msg, t in bag.read_messages(topics=['/transport/calibrated_pcd']):
                    if rospy.is_shutdown():
                        break
                    self.calibrated_pcd_pub.publish(msg)
                    rospy.sleep(0.1)  # Adjust the sleep duration as needed
        except Exception as e:
            rospy.logerr(f"Error reading or publishing from rosbag: {e}")
...
if __name__ == '__main__':
    try:
        ...
        # bag_path = '/home/toine/catkin_ws/src/arm_pcd_27jan_2.bag'
        bag_path = '/calibrated_pcd30dec.bag'
        # csv_file_path = '/home/toine/catkin_ws/src/realsense/4feb_dense_demo.csv'
        # csv_file_path = '/home/toine/catkin_ws/src/realsense/14feb_arm_demo.csv'
        # csv_file_path = '/home/toine/catkin_ws/src/realsense/4feb_male_demo.csv'
        # csv_file_path = '/home/toine/catkin_ws/src/traj_csvs/arm_poses_27jan.csv'
        # csv_file_path = '/home/toine/catkin_ws/src/realsense/18feb_demo.csv'
        # csv_file_path = '/home/toine/catkin_ws/src/traj_csvs/20jan_static_demo.csv'
        csv_file_path = '/home/toine/catkin_ws/src/traj_csvs/poses_19dec.csv'
